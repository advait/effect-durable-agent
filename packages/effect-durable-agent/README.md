...
| [`005-rivet-no-tools`](https://github.com/advait/effect-durable-agent/tree/master/examples/005-rivet-no-tools) | Native Rivet Actor with actor-local SQLite and typed client actions. |
