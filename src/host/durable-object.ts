...
import type { CommittedDurableEvent as CommittedDurableEventValue } from "../services/session-store";
import type { CommittedCommandTerminalEvent, EDARuntimeConfig } from "../services/runtime";
import { EDACommand, type EDACommand as EDACommandValue } from "../types/commands";
...
> extends DurableObject<EnvType> {
  ...
  protected constructor(
    ...
    super(ctx, env);
    const storage = this.ctx.storage as unknown as EDASessionDurableObjectStorage;
